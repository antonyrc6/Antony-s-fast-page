...
type: ap
week: 7
nb_path: _notebooks/2022-10-03-AP-Error-Correction.ipynb
layout: notebook
---
...
#################################################
# file to edit: _notebooks/2022-10-03-AP-Error-Correction.ipynb
-->
...
<span class="k">while</span> <span class="kc">True</span><span class="p">:</span>
    ...
    <span class="k">else</span><span class="p">:</span>
        <span class="n">order</span><span class="o">.</span><span class="n">append</span><span class="p">(</span><span class="n">item</span><span class="p">)</span>
