...
type: pbl
week: 9
nb_path: _notebooks/2022-10-19-Python-Web-API-Using-Jokes.ipynb
layout: notebook
---
...
#################################################
# file to edit: _notebooks/2022-10-19-Python-Web-API-Using-Jokes.ipynb
-->
...
Random joke
13 Q: Why is it that programmers always confuse Halloween with Christmas? A: Because 31 OCT = 25 DEC. 
 haha: 7 
 boohoo: 4 
